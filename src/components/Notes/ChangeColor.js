            ...
            {pickingColorAll &&(
                            <div className='color-options'>
                                <ul className='color-options-list'>
                                    ...
                                    <li onClick={(e) => {props.setNewColor(e.target.style.backgroundColor); setPickingColorAll(false); console.log(e)}} className='color-item' style={{backgroundColor: '#ffccd5'}}></li>
